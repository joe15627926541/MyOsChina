...
import comprehensive.XmlParse.BlogDetailXmlParser;
...
public class BlogDetailFragment extends BaseFragment {
    ...
    public LoadingPage.ResultState onLoad() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://www.oschina.net/action/api/blog_detail?id=" + (position + 1), new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                InputStream is = new ByteArrayInputStream(s.getBytes());
                mList = BlogDetailXmlParser.DetailxmlParser(is);
