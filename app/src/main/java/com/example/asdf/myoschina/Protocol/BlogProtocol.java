...
import com.example.asdf.myoschina.XmlParse.BlogXmlParser;
...
public class BlogProtocol extends BaseProtocol<ArrayList<SoftWareInfo>> {
    /*
    *
    *
    * */
    ...
    public String getParams() {
        ...
        System.out.println("---------position博客"+position+"----str"+str);
        return str;
    }

    @Override
    public ArrayList<SoftWareInfo> parseJson(String result) {
        System.out.println("-----解析博客"+result);
        ArrayList<SoftWareInfo> softwareinfos= null;
        InputStream is = new ByteArrayInputStream(result.getBytes());
        softwareinfos= BlogXmlParser.BlogxmlParser(is);
