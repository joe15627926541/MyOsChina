...
public class HotMoveXmlParser {


    public static ArrayList<recentmoveInfo> HotXmlMoveParser(InputStream in) {
        ...
        System.out.println("11111热门动弹大小"+recentmoveInfos.size()+recentmoveInfos.toString());
