...
public class RecentMoveXmlParser {


    public ArrayList<recentmoveInfo> RecentMovexmlParser(InputStream in) {
        ...
        System.out.println("11111最近动弹大小"+recentmoveInfos.size()+recentmoveInfos.toString());
